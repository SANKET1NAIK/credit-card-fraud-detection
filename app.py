...
def home():
    ...
    education_status = ["Graduate School",
    ...
    try:
        if request.method == 'POST':
            ...
            features['EDUCATION'] = education_status.index(
                features['EDUCATION']) + 1
            features['MARRIAGE'] = marital_status.index(
                features['MARRIAGE']) + 1
            features['PAY_1'] = payment_status.index(features['PAY_1']) - 2

            actual_feature_names = ['LIMIT_BAL', 'EDUCATION', 'MARRIAGE', 'AGE', 'PAY_1', 'BILL_AMT1', 'BILL_AMT2', 'BILL_AMT3',
